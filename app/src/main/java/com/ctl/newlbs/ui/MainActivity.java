...
import com.ctl.newlbs.bluetooth.BluetoothConn;
import com.ctl.newlbs.bluetooth.BluetoothState;
import com.ctl.newlbs.bluetooth.RevThread;
...
import com.ctl.newlbs.utils.LocationPoint;
import com.ctl.newlbs.utils.Utils;
...
public class MainActivity extends Activity implements Observer,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothConn = new BluetoothConn("CTL_LC", 5000);
...
//                        builder1.setTitle("关于本机");
//                        builder1.setMessage("软件版本：1.2.0V");
...
//                        break;
                    case 2:
                        ...
                        devNumEdBuilder.setPositiveButton("取消", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                String numberStr = devNumEd.getText().toString().replaceAll(" ","");
                                if(numberStr==null||numberStr.length()==0){
                                    Utils.alertDialog(context,"温馨提示","设备编号不能空","确定");
                                    return;
                                }
        ...
        logoView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                bluetoothConn.sendCmd("BC+SETLTE=0");
            }
        });
